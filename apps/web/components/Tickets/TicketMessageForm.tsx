...
export default function TicketMessageForm({ onSubmit, loading }: TicketMessageFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
                <Button type="submit" variant="primary" loading={loading} disabled={!message.trim()}>
                    Enviar Mensagem
                </Button>
            </div>
        </form>
